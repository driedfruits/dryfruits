...
const HomePage = lazy(() => import("./assets/HomePage-BmZRb5V7.js"));
const ProductsPage = lazy(() => import("./assets/ProductsPage-BhJzT_wm.js"));
const ProductDetailPage = lazy(() => import("./assets/ProductDetailPage-DY_gRl6e.js"));
const AboutPage = lazy(() => import("./assets/AboutPage-tmvFAYq_.js"));
const ContactPage = lazy(() => import("./assets/ContactPage-DaYlp2JW.js"));
const FAQPage = lazy(() => import("./assets/FAQPage-De3NIqT5.js"));
const CertificationsPage = lazy(() => import("./assets/CertificationsPage-CipAXCz8.js"));
const SustainabilityPage = lazy(() => import("./assets/SustainabilityPage-Btz5zpR9.js"));
const ShippingPage = lazy(() => import("./assets/ShippingPage-Bttn3TSI.js"));
const PrivateLabelPage = lazy(() => import("./assets/PrivateLabelPage-DVbt7SQ0.js"));
const SamplesPage = lazy(() => import("./assets/SamplesPage-BSJ5ZRvF.js"));
const CatalogPage = lazy(() => import("./assets/CatalogPage-BJukjFiQ.js"));
const StorageGuidePage = lazy(() => import("./assets/StorageGuidePage-BBT2hJSl.js"));
const PrivacyPage = lazy(() => import("./assets/PrivacyPage-CCLzFENq.js"));
const TermsPage = lazy(() => import("./assets/TermsPage-sl9k6RyP.js"));
const NotFound = lazy(() => import("./assets/NotFound-B0Xd1hpy.js"));
const ProductEditorPage = lazy(() => import("./assets/ProductEditorPage-BC8vrt_x.js"));
const DesignSystemPage = lazy(() => import("./assets/DesignSystemPage-CsdWTJZi.js"));
...
function RootLayout() {
  return /* @__PURE__ */ jsx(HelmetProvider, { children: /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxs(TooltipProvider, { children: [
