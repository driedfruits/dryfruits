...
export const products: Product[] = [
  ...
  // Powdered Dried Fruits
  {
    ...
    description: "Premium drum-dried papaya powder. Rich in natural enzymes and vitamins, perfect for smoothies, baking, and food manufacturing.",
    specifications: {
      size: "80-100 mesh",
      moisture: "4-6%",
    ...
    applications: ["Smoothies", "Baking", "Baby food", "Supplements", "Beverages"],
    packaging: { bulk: "20-25 kg bags", retail: "100g-500g pouches", custom: true },
    pricing: { fobBase: "Contact for pricing", moq: "500 kg", leadTime: "2-3 weeks" },
    certifications: ["USDA Organic", "EU Organic"],
    isOrganic: true,
  ...
  },
  {
    ...
    description: "Fine pineapple powder made from premium Cayenne pineapples. Perfect for beverages, baking, and natural flavoring.",
    specifications: {
      size: "80-100 mesh",
      moisture: "4-6%",
      color: "Light Yellow",
    ...
    applications: ["Beverages", "Baking", "Confectionery", "Smoothies", "Natural flavoring"],
    packaging: { bulk: "20-25 kg bags", retail: "100g-500g pouches", custom: true },
    pricing: { fobBase: "Contact for pricing", moq: "500 kg", leadTime: "2-3 weeks" },
    certifications: ["USDA Organic", "EU Organic"],
    isOrganic: true,
  ...
  },
  {
    ...
    applications: ["Beverages", "Ice cream", "Baking", "Smoothies", "Confectionery"],
    packaging: { bulk: "20-25 kg bags", retail: "100g-500g pouches", custom: true },
    pricing: { fobBase: "Contact for pricing", moq: "500 kg", leadTime: "2-3 weeks" },
    certifications: ["USDA Organic", "EU Organic"],
    isOrganic: true,
  ...
  },
  {
    ...
    applications: ["Natural coloring", "Smoothie bowls", "Confectionery", "Beverages", "Desserts"],
    packaging: { bulk: "10-20 kg bags", retail: "50g-300g pouches", custom: true },
    pricing: { fobBase: "Contact for pricing", moq: "300 kg", leadTime: "2-3 weeks" },
    certifications: ["USDA Organic", "EU Organic"],
    isOrganic: true,
  ...
  },
  {
    ...
    applications: ["Baking", "Beverages", "Confectionery", "Cooking", "Smoothies"],
    packaging: { bulk: "25 kg bags", retail: "100g-1kg pouches", custom: true },
    pricing: { fobBase: "Contact for pricing", moq: "1 ton", leadTime: "2-3 weeks" },
    certifications: ["USDA Organic", "EU Organic"],
    isOrganic: true,
  ...
  },
  {
    ...
    applications: ["Beverages", "Desserts", "Baking", "Ice cream", "Confectionery"],
    packaging: { bulk: "15-20 kg bags", retail: "100g-500g pouches", custom: true },
    pricing: { fobBase: "Contact for pricing", moq: "500 kg", leadTime: "2-3 weeks" },
    certifications: ["USDA Organic", "EU Organic"],
    isOrganic: true,
