...
export const products: Product[] = [
  ...
  // ==================
  {
    ...
    sku: "DFT-VFP-001",
    hsCode: "2008.99.90",
    tagline: "Crispy tropical innovation with 80-90% nutrient retention",
    description: "Premium vacuum fried papaya chips processed at low temperature (80-120°C) under vacuum to preserve natural color, flavor, and nutrients. Significantly lower oil content than traditional frying with ultra-crisp texture. Ideal for health-conscious snacking markets.",
    flavorProfile: "Concentrated sweet papaya with caramelized notes and intense tropical aroma",
    texture: "Ultra-crispy, light crunch, non-greasy finish",
    metaTitle: "Wholesale Vacuum Fried Papaya Chips - Bulk Export from Indonesia",
    metaDescription: "Premium vacuum fried papaya chips from Indonesia. 15-20% oil (low-fat), ≤5% moisture, aw ≤0.35. HACCP certified. Nitrogen-flushed bulk packs. MOQ 300kg.",
    keywords: ["vacuum fried papaya", "papaya chips wholesale", "healthy fruit chips", "low-fat papaya chips", "vacuum fried papaya specifications"],
    specifications: {
      size: "Chips/Slices 3-5mm",
      sliceThickness: "3-5mm uniform",
      moisture: "≤5%",
      waterActivity: "≤0.35 aw (crisp grade)",
      color: "Orange (80-90% color retention)",
      shelfLife: "12-18 months",
      origin: "Central Java, Indonesia",
      oilContent: "15-20% db (low-fat vs 40-50% atmospheric)",
      fryingTemperature: "80-120°C",
      vacuumPressure: "0.08-0.1 MPa",
      peroxideValue: "<10 meq O₂/kg",
      freeFattyAcids: "<1.5 mg KOH/g",
      colorRetention: "80-90% vs traditional frying",
      vitaminRetention: "80-90% preserved",
      additives: "No artificial additives",
      foreignMatter: "0%",
      processingMethod: "Vacuum frying (low temperature, 10-30 min)",
      grade: "Premium Export Quality",
      totalPlateCount: "<10⁴ CFU/g",
      yeastMold: "<10² CFU/g",
      salmonella: "Absent/25g",
      eColi: "Absent",
      so2Level: "None (preservative-free)",
      storageTemp: "<20°C (cool dry)",
      storageHumidity: "<55% RH",
      packagingMethod: "Nitrogen-flushed foil liner in cartons",
      testingMethod: "Soxhlet extraction (AOAC method)",
    },
    availability: {
      peakSeason: "Year-round",
      currentStatus: "in-stock",
    },
    applications: ["Premium snacking", "Gift packs", "Retail products", "Hotel minibars", "Trail mix", "Healthy snack lines"],
    packaging: { bulk: "5-10 kg cartons with nitrogen flush & foil liner", retail: "30g-150g nitrogen-flushed pouches", custom: true },
    pricing: {
    ...
    compliance: {
      usa: "FDA facility registered; Prior Notice compliant",
      eu: "Phytosanitary certified; MRL compliant (pesticide residues); Health Certificate",
      global: "GFSI-aligned (HACCP); Codex Alimentarius compliant",
    },
    faqs: [
      { question: "What is the oil content and how is it measured?", answer: "Our vacuum fried papaya contains 15-20% oil on a dry basis (db), measured via Soxhlet extraction (AOAC method). This is significantly lower than atmospheric fried chips (40-50% oil)." },
      { question: "How does vacuum frying preserve nutrients?", answer: "Vacuum frying at 80-120°C under 0.08-0.1 MPa vacuum preserves 80-90% of natural color, vitamins (especially Vitamin A), and flavor compared to traditional high-temperature frying." },
      { question: "What is the water activity level for crispness?", answer: "Premium export grade maintains aw ≤0.35 for ultra-crisp texture. This low water activity ensures 12-18 month shelf life and prevents texture degradation." },
      { question: "How do you prevent rancidity during storage?", answer: "Low oil content (<20%), nitrogen-flushed packaging, peroxide value control (<10 meq/kg), and cool storage (<20°C) ensure 12-18 month shelf life without rancidity." },
      { question: "What certifications are available for export?", answer: "HACCP, HALAL, Kosher certified. GFSI-aligned (BRC/IFS/FSSC 22000 available). Phytosanitary certificates, lab tests for pesticides (EU MRLs), and full traceability documentation included." },
    ],
    certifications: ["USDA Organic", "HACCP", "Halal", "Kosher"],
    isOrganic: true,
    relatedProducts: ["vacuum-banana", "vacuum-pineapple", "vacuum-mango", "dried-papaya"],
  },
  {
    id: "vacuum-banana",
    ...
    sku: "DFT-VFB-001",
    hsCode: "2008.99.90",
    tagline: "Crispy, non-greasy banana chips with controlled oil content",
    description: "Premium vacuum fried banana chips with superior crunch and reduced oil absorption. Processed at 80-110°C under vacuum to achieve crispy, non-greasy texture. Strict rancidity controls ensure extended shelf life for export markets.",
    flavorProfile: "Sweet caramelized banana with natural richness and golden crunch",
    texture: "Perfectly crispy, satisfying crunch, non-greasy",
    metaTitle: "Wholesale Vacuum Fried Banana Chips - Bulk Export from Indonesia",
    metaDescription: "Premium vacuum fried banana chips from Indonesia. 20-30% oil (target <30%), ≤5% moisture. HACCP certified. Aluminum foil packaging. MOQ 500kg.",
    keywords: ["vacuum fried banana", "banana chips wholesale", "healthy banana chips", "low-fat banana chips", "vacuum fried banana specifications"],
    specifications: {
      size: "Chips/Coins 3-5mm",
      sliceThickness: "3-5mm uniform",
      moisture: "2-5%",
      waterActivity: "≤0.40 aw",
      color: "Golden Yellow (crisp, non-greasy)",
      shelfLife: "12 months",
      origin: "Lampung, Indonesia",
      oilContent: "20-30% db (target <30%)",
      fryingTemperature: "80-110°C",
      vacuumPressure: "0.08-0.1 MPa",
      peroxideValue: "<10 meq O₂/kg",
      freeFattyAcids: "<1.5 mg KOH/g",
      colorRetention: "85-90% vs traditional frying",
      vitaminRetention: "80-90% preserved",
      additives: "No artificial additives",
      foreignMatter: "0%",
      processingMethod: "Vacuum frying (low temperature, structural optimization)",
      grade: "Premium Export Quality",
      totalPlateCount: "<10⁴ CFU/g",
      yeastMold: "<10² CFU/g",
      salmonella: "Absent/25g",
      ...
      storageTemp: "<20°C (cool dry)",
      storageHumidity: "<55% RH",
      packagingMethod: "Aluminum foil bag in cartons",
      testingMethod: "Soxhlet extraction (AOAC method)",
    },
    availability: {
      peakSeason: "Year-round",
    ...
    applications: ["Snacking", "Ice cream toppings", "Breakfast cereals", "Chocolate coating", "Trail mix", "Healthy snack lines"],
    packaging: { bulk: "10-20 kg cartons with aluminum foil liner", retail: "50g-200g nitrogen-flushed pouches", custom: true },
    pricing: {
      fobBase: "From $8.00/kg FOB",
      moq: "500 kg",
      leadTime: "2-3 weeks",
    ...
    logistics: {
      ...
      incoterms: ["FOB", "CIF", "CFR"],
      containerLoad20ft: "10-12 MT",
      containerLoad40ft: "15-18 MT",
    },
    compliance: {
      usa: "FDA facility registered; Prior Notice compliant",
      eu: "Phytosanitary certified; MRL compliant; Health Certificate",
      global: "GFSI-aligned (HACCP); GlobalG.A.P. available",
    },
    faqs: [
      { question: "Why is banana chip oil content higher than other fruits?", answer: "Banana's unique cell structure results in 20-30% oil on dry basis. We optimize processing to keep it below 30% while maintaining crispy texture - still 40% less than atmospheric frying (50%+)." },
      { question: "How do you prevent rancidity in banana chips?", answer: "Strict controls: peroxide value <10 meq/kg, free fatty acids <1.5 mg KOH/g, nitrogen-flushed packaging, and cool storage (<20°C). Quarterly testing ensures 12-month shelf stability." },
      { question: "What banana variety do you use?", answer: "We use Meishijiao and local Lampung varieties selected for optimal crispness after vacuum frying. Firm texture bananas produce superior chip quality." },
      { question: "What is the water activity for crisp texture?", answer: "Our banana chips maintain aw ≤0.40 for crisp texture. Lower moisture (2-5%) prevents softening during storage and transit." },
      { question: "What certifications are included?", answer: "HACCP, HALAL certified. GlobalG.A.P. available. Full traceability, phytosanitary certificates, and lab tests for pesticides (EU MRLs) included." },
    ],
    certifications: ["USDA Organic", "HACCP", "Halal"],
    isOrganic: true,
    relatedProducts: ["vacuum-papaya", "vacuum-pineapple", "vacuum-mango", "dried-banana"],
  },
  {
    id: "vacuum-pineapple",
    ...
    sku: "DFT-VFPI-001",
    hsCode: "2008.99.90",
    tagline: "Ultra-crisp tangy sensation with optimized ~20% oil content",
    description: "Premium vacuum fried pineapple chips with intense sweet-tangy flavor. Optimized processing at 110°C/25 min achieves ultra-low water activity (aw <0.29) for maximum crispness. Industry-leading ~20% oil content for healthy snack positioning.",
    flavorProfile: "Intense tangy-sweet with concentrated pineapple essence and caramelized notes",
    texture: "Ultra-crisp, light and airy, delicate crunch",
    metaTitle: "Wholesale Vacuum Fried Pineapple Chips - Bulk Export from Indonesia",
    metaDescription: "Premium vacuum fried pineapple chips from Indonesia. Optimized ~20% oil, ≤4% moisture, ultra-low aw <0.29. HACCP certified. MOQ 300kg.",
    keywords: ["vacuum fried pineapple", "pineapple chips wholesale", "healthy fruit chips", "low-fat pineapple chips", "vacuum fried pineapple specifications"],
    specifications: {
      size: "Chips/Rings 3-5mm",
      sliceThickness: "3-5mm uniform",
      moisture: "≤4%",
      waterActivity: "≤0.29 aw (ultra-crisp)",
      color: "Golden Yellow",
      shelfLife: "12-18 months",
      origin: "Lampung, Indonesia",
      oilContent: "15-20% db (~20% optimized)",
      fryingTemperature: "110°C / 25 min",
      vacuumPressure: "0.08-0.1 MPa",
      peroxideValue: "<10 meq O₂/kg",
      freeFattyAcids: "<1.5 mg KOH/g",
      colorRetention: "85-90% vs traditional frying",
      vitaminRetention: "80-90% preserved (Vitamin C)",
      additives: "No artificial additives",
      foreignMatter: "0%",
      processingMethod: "Vacuum frying (optimized low temperature)",
      grade: "Premium Export Quality",
      totalPlateCount: "<10⁴ CFU/g",
      yeastMold: "<10² CFU/g",
      salmonella: "Absent/25g",
    ...
    applications: ["Premium snacking", "Cocktail garnish", "Dessert toppings", "Trail mix", "Gift packs", "Healthy snack lines"],
    packaging: { bulk: "5-10 kg cartons with nitrogen flush & foil liner", retail: "30g-150g nitrogen-flushed pouches", custom: true },
    pricing: {
    ...
    faqs: [
      { question: "What makes your pineapple chips ultra-crisp?", answer: "Optimized vacuum frying at 110°C for 25 minutes achieves ultra-low water activity (aw <0.29) - significantly crispier than standard aw ≤0.60. This ensures maximum crunch throughout shelf life." },
      { question: "What is the optimized oil content?", answer: "Our pineapple chips achieve ~20% oil on dry basis through optimized processing conditions. This is 50-60% less than atmospheric fried chips (40-50% oil)." },
      { question: "How long is the shelf life?", answer: "12-18 months with proper storage (<20°C, <55% RH). Ultra-low water activity and nitrogen-flushed packaging prevent both texture loss and oil oxidation." },
      { question: "What rancidity controls are in place?", answer: "Peroxide value <10 meq O₂/kg, free fatty acids <1.5 mg KOH/g. Quarterly testing and oxygen-barrier packaging with nitrogen flush ensure no off-flavors develop." },
      { question: "What certifications are included?", answer: "HACCP, HALAL certified. Full traceability, phytosanitary certificates, COA with lab tests for pesticides (EU MRLs), and microbiology included." },
    ],
    certifications: ["USDA Organic", "HACCP", "Halal"],
    isOrganic: true,
    relatedProducts: ["vacuum-papaya", "vacuum-banana", "vacuum-mango", "dried-pineapple"],
  },
  {
    id: "vacuum-mango",
    ...
    sku: "DFT-VFM-001",
    hsCode: "2008.99.90",
    tagline: "Intense mango crunch with premium 12-25% oil content",
    description: "Premium vacuum fried mango chips with concentrated tropical flavor. Processed at 100-120°C under vacuum to preserve natural color, aroma, and nutrients. Ripe mango chips offer sweeter flavor (18-25% oil), while unripe variants provide tangier taste with lower oil (12-20%).",
    flavorProfile: "Intensely sweet mango with aromatic depth and caramelized tropical notes",
    texture: "Perfectly crispy, melts in mouth, premium crunch",
    metaTitle: "Wholesale Vacuum Fried Mango Chips - Bulk Export from Indonesia",
    metaDescription: "Premium vacuum fried mango chips from Indonesia. 12-25% oil, ≤5% moisture, aw ≤0.35. BRC/ISO 22000 available. Nitrogen-flushed bulk packs. MOQ 300kg.",
    keywords: ["vacuum fried mango", "mango chips wholesale", "healthy mango chips", "low-fat mango chips", "vacuum fried mango specifications"],
    specifications: {
      size: "Chips/Slices 3-5mm",
      sliceThickness: "3-5mm uniform",
      moisture: "≤5%",
      waterActivity: "≤0.35 aw (crisp grade)",
      color: "Deep Orange (80-90% retention)",
      shelfLife: "12-18 months",
      origin: "East Java, Indonesia",
      oilContent: "12-25% db (ripe: 18-25%, unripe: 12-20%)",
      fryingTemperature: "100-120°C",
      vacuumPressure: "0.08-0.1 MPa",
      peroxideValue: "<10 meq O₂/kg",
      freeFattyAcids: "<1.5 mg KOH/g",
      colorRetention: "80-90% vs traditional frying",
      vitaminRetention: "80-90% preserved (Vitamin A, C)",
      additives: "No artificial additives",
      foreignMatter: "0%",
      processingMethod: "Vacuum frying (low temperature, 10-30 min)",
      grade: "Premium Export Quality",
    ...
    applications: ["Gourmet snacking", "Gift packs", "Retail products", "Trail mix", "Premium food service", "Healthy snack lines"],
    packaging: { bulk: "5-10 kg cartons with nitrogen flush & foil liner", retail: "30g-150g nitrogen-flushed pouches", custom: true },
    pricing: {
      fobBase: "From $18.00/kg FOB",
      moq: "300 kg",
    ...
    compliance: {
      usa: "FDA facility registered; Prior Notice compliant",
      eu: "Phytosanitary certified; MRL compliant; Health Certificate",
      global: "GFSI-aligned (BRC/IFS/FSSC 22000 available); ISO 22000",
    },
    faqs: [
      { question: "What's the difference between ripe and unripe mango chips?", answer: "Ripe mango chips are sweeter with deeper orange color and 18-25% oil content. Unripe mango chips are tangier with lighter color and lower oil (12-20%). Both maintain excellent crispness." },
      { question: "How does vacuum frying preserve mango color?", answer: "Low-temperature processing (100-120°C) under vacuum preserves 80-90% of natural carotenoids vs. traditional frying. Deep orange color is retained without artificial additives." },
      { question: "What is the water activity for crisp grade?", answer: "Premium export grade maintains aw ≤0.35 for ultra-crisp texture. Published data shows mango can reach ~5.2% moisture at 120°C/10 min - we optimize for crispness." },
      { question: "How do you prevent rancidity?", answer: "Low oil content (target <25%), peroxide value <10 meq/kg, free fatty acids <1.5 mg KOH/g. Nitrogen-flushed foil packaging and cool storage ensure 12-18 month shelf life." },
      { question: "What certifications are available?", answer: "HACCP, HALAL certified. BRC/IFS/FSSC 22000 available for EU/US markets. ISO 22000 certified. Full traceability and COA included." },
    ],
    certifications: ["USDA Organic", "HACCP", "Halal", "ISO 22000"],
    isOrganic: true,
    relatedProducts: ["vacuum-papaya", "vacuum-banana", "vacuum-pineapple", "dried-mango"],
  },
