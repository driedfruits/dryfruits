...
export const products: Product[] = [
  ...
  // ==================
  {
    ...
    hsCode: "0813.40.4",
    images: {
      gallery: [{ src: "", alt: "" }, { src: "", alt: "" }, { src: "", alt: "" }, { src: "", alt: "" }],
    },
  ...
  },
  {
    ...
    metaDescription:
      "Wholesale Bulk Dried Pineapple from Indonesia. ✓ 100% sugar-free rings & chunks. Custom B2B packing. ⏳ 5-day production time. 🔥 Request a quote today!",
    keywords: [
    ...
    harvestMonths: [0, 1, 1, 2, 2, 2, 2, 1, 0, 1, 2, 2],
    specifications: {
      ...
      brixLevel: "55 - 65 °Bx  (no sugar added)",
      additives: "Preservative-free / Sulfite-free options",
      foreignMatter: "0%",
