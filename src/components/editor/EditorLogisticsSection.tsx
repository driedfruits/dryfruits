...
const EditorLogisticsSection = ({ portOfLoading, setPortOfLoading, incoterms, setIncoterms, containerLoad20ft, setContainerLoad20ft, containerLoad40ft, setContainerLoad40ft, estimatedDelivery, setEstimatedDelivery, exportDocuments, setExportDocuments }: EditorLogisticsSectionProps) => (
  <div className="space-y-4 rounded-lg border border-border p-4">
    ...
    <FormInput label="Estimated Delivery" value={estimatedDelivery} onChange={(e) => setEstimatedDelivery(e.target.value)} placeholder="e.g. 14-21 days from port of loading" />
