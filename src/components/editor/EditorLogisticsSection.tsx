...
const EditorLogisticsSection = ({ portOfLoading, setPortOfLoading, incoterms, setIncoterms, containerLoad20ft, setContainerLoad20ft, containerLoad40ft, setContainerLoad40ft }: EditorLogisticsSectionProps) => (
