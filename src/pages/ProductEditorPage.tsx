  ...
  return (
    <div className="min-h-screen bg-background p-4 sm:p-8 max-w-3xl mx-auto">
      ...
      <div className="mt-4 space-y-6">
        ...
        <EditorImagesSection imgMain={editor.imgMain} imgMainAlt={editor.imgMainAlt} setImgMainAlt={editor.setImgMainAlt} imgThumb={editor.imgThumb} imgThumbAlt={editor.imgThumbAlt} setImgThumbAlt={editor.setImgThumbAlt} imgGallery={editor.imgGallery} updateGalleryImage={editor.updateGalleryImage} />
        ...
        <EditorPackagingSection bulk={editor.packagingBulk} setBulk={editor.setPackagingBulk} retail={editor.packagingRetail} setRetail={editor.setPackagingRetail} errors={editor.validationErrors} />
